    ...
    */
    ...
    'connections' => [
        ...
        'application' => [
            ...
            'host' => env('DB_CORE_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_UNIVERSAL_APPLICATION_DATABASE', 'forge'),
            'username' => env('DB_CORE_USERNAME', 'forge'),
            'password' => env('DB_CORE_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
        ...
        'stock' => [
            'driver'   => env('DB_STOCK_DRIVER', 'sqlsrv'),
            'host'     => env('DB_STOCK_HOST', 'localhost'),
        ...
        'ho' => [
            ...
            'host'     => env('DB_STOCK_HOST', 'localhost'),
            'port'     => env('DB_STOCK_PORT', '1433'),
            'database' => env('DB_HO_DATABASE', 'forge'),
            'username' => env('DB_STOCK_USERNAME', 'forge'),
            'password' => env('DB_STOCK_PASSWORD', ''),
            'charset'  => 'utf8',
            'prefix'   => '',
